...
// @description 在各种搜索网站中自由切换，避免关键词的重复输入！帮助我们快速搜索，👉一步直达👈 。脚本现在已经内置常用搜索包括：常见搜索引擎、视频网站、音乐网站、购物网站、知识搜索等。快捷键【Win+F】快速唤起。
...
(function () {
	...
	function loadingIcon(icon){
		...
		return "https://cdn.statically.io/gh/xanthella/icon-svg/master/" + icon + ".svg";
	}
	...
	const So360 = new SiteInfo('360搜索', 'https://www.so.com/s?ie=utf-8&q=%s', 'https://www.so.com/', 'so360');
            ...
            },
			{
				...
				engines:[
					...
					},
					{
					    ...
					    home: 'https://search.bilibili.com',
					    icon: 'bilibili',
						enable: true
					},
					{
    ...
    const defaultSheet = `
        ...
        */
		...
		.qs-main-background-mascot >img{
			width:100%!important;
			height:100%!important;
		}
		.qs-main-background-mascot >span{
		...
		.qs-main-search-box:hover{
			border-color:#4E71F2 !important;
		}
		.qs-main-search-box-platform-icon{
		...
		/* 选择默认搜索弹窗 */
		.qs-main-switch-search-engines-box{
			all: initial !important;
			position: absolute!important;
			top: 65px!important;
			left: 0px !important;
		...
		.qs-main-switch-search-engines-box::before {
			all: initial !important;
			content: '' !important;
			width: 0px !important;
		...
		.qs-main-switch-search-engines-items{
			all: initial !important;
			display: flex !important;
			flex-direction: row !important;
			flex-wrap: wrap !important;
		}
		.qs-main-switch-search-engines-items >li{
			all: initial !important;
		...
		.qs-main-switch-search-engines-items >li:hover{
			background-color: #dfdfdf !important;
		}
		.qs-main-switch-search-engines-items >li >img{
			all: initial !important;
			display: inline-block !important;
			vertical-align: middle !important;
		...
		.qs-main-switch-search-engines-items >li >span{
			all: initial !important;
			display: inline-block !important;
			vertical-align: middle !important;
	...
	function QuickSearch(commonTools, conf){
		...
		this.createMainBox=function(){
			...
			backgroundMascot.className = 'qs-main-background-mascot';
			...
			letTip.textContent = commonTools.getPlatform()=="mac" ? '组合键：Option + F唤起' : "组合键：Alt + F唤起";
			...
			searchOuterBox.className = 'qs-main-search-outer-box';
			searchOuterBox.id = 'qs-main-search-outer-box';
			...
			platformIcon.id = 'qs-main-search-box-platform-icon';
			platformIcon.className = 'qs-main-search-box-platform-icon';
			...
			switchSearchEngines.className = 'qs-main-switch-search-engines-box';
			switchSearchEngines.style.setProperty('display', 'none', 'important');
			const searchEngineItems = document.createElement('ul');
			searchEngineItems.className='qs-main-switch-search-engines-items';
			...
			inputClearBtn.className = 'qs-main-search-box-clear-btn';
			...
			mainBox.addEventListener("click",(e)=>{
				if(!event.target.closest('#qs-main-search-box-platform-icon')) {
					switchSearchEngines.style.setProperty('display', 'none', 'important');
				}
			});
    ...
    window.addEventListener('keydown', function (e) {
        ...
        if (e.code == 'KeyS') {
            ...
            } else if (!quickSearch.isMainBoxVisual()) {
                quickSearch.showMainBox();
            } else {
                quickSearch.hideMainBox();
            }
        ...
        window.addEventListener('message', function (e) {
            ...
            if (e.data.keydown) {
                if (e.data.keydown == 'Alt+KeyF') {
                    if (!qsPageLock) {
                        if (!quickSearch.isMainBoxVisual()) {
                            quickSearch.showMainBox(e.data.query);
                        } else {
                            quickSearch.hideMainBox();
                        }
                    }
		...
		this.show=function(){
			if(this.isShow()){
				if(commonTools.getPlatform() == "mac"){
					infoTips.showInfoTipsLayer("快捷键【Option + F】可唤起快搜窗口！", 6000);
				}else{
					infoTips.showInfoTipsLayer("快捷键【Alt + F】可唤起快搜窗口！", 6000);
				}
			}
		};
	}
